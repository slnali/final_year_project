...
class BookingAvailabilityModelTests(TestCase):
    ...
    def setUp(self):
        ...
        social_token = SocialToken.objects.create(account_id=1,app_id=1,expires_at=datetime.date(2018,2,9)) #create token and link to account
    ...
    def test_get_next_7_days(self):
        ...
        self.assertEqual(next_7_days,[ datetime.date(2018,2,10),datetime.date(2018,2,11),datetime.date(2018,2,12),
